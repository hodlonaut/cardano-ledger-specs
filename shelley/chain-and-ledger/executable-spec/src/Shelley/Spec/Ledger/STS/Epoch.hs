...
instance ShelleyEra era => STS (EPOCH era) where
...
instance ShelleyEra era => Embed (SNAP era) (EPOCH era) where
  wrapFailed = SnapFailure

instance ShelleyEra era => Embed (POOLREAP era) (EPOCH era) where
  wrapFailed = PoolReapFailure

instance ShelleyEra era => Embed (NEWPP era) (EPOCH era) where
